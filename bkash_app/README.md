...
<img height="500" alt="bKash App Screenshot" src="https://github.com/user-attachments/assets/5b632ab9-16a5-4942-b0b2-daaf96d7ae1a" />
...
└── presentation/
    ...
    └── screens/
        ...
        ├── login/              # LoginScreen
        └── home/               # HomeScreen
            └── widget/         # HomeAppBar, MenuGrid, MenuGridItem
```
...
| `HomeProvider` at the presentation root | Shared across screens without being buried inside a single feature folder |
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/<your-username>/bkash_app.git
   cd bkash_app
   ```
